              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      SizedBox(height: 30),
                      Text(productName, style: TextStyle(fontFamily: "mukta", color: Color(0xffE4A951), fontSize: 35)),
                      SizedBox(height: 20),
                      Container(
                        height: height / 3,
                        width: width / 2,
                      ...
                      SizedBox(height: 20),
                      Text(productPrice, style: TextStyle(color: Colors.white, fontFamily: "mukta", fontSize: 35)),
                    ],
                  ),
                ),
                SizedBox(height: 30),
