            ...
            Expanded(
              child: Consumer<MainProvider>(
                builder: (context, mainProvider, child) {
                  // Display orders if they exist, or a message if empty
                  if (mainProvider.orderList.isEmpty) {
                    return Center(
                      child: Text(
                        "No orders found.",
                        style: TextStyle(
                  ...
                  return ListView.builder(
                    itemCount: mainProvider.orderList.length,
                    itemBuilder: (context, index) {
                      var order = mainProvider.orderList[index];
                      return Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Container(
                          height: height / 8,
